...
export default function TeamManagement({
  ...
  const canManageMembers =
    roleDetails?.currentUserRole &&
    ['OWNER', 'ADMIN'].includes(roleDetails.currentUserRole)
                        ...
                        <div>
                          <div className='flex items-center gap-2'>
                            ...
                            <Badge
                              className={
                                ROLE_COLORS[
                                  invitation.role as keyof typeof ROLE_COLORS
                                ]
                              }
                            >
                              {invitation.role}
        ...
        <TabsContent value='roles' className='space-y-6'>
          <Card className='bg-gradient-to-br from-gray-900/50 to-gray-800/50 border-gray-800'>
            <CardHeader>
              ...
              <CardDescription>
                Understanding team member permissions and access levels
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='grid gap-4'>
                {roleDetails?.roles.map((role: any) => {
                  const RoleIcon =
                    ROLE_ICONS[role.id as keyof typeof ROLE_ICONS]
                  ...
                  return (
                    ...
                    >
                      <div className='flex items-center gap-4'>
                        <div
                          className={`p-2 rounded-lg ${ROLE_COLORS[role.id as keyof typeof ROLE_COLORS]}`}
                        >
