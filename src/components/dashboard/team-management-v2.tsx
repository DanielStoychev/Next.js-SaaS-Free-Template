...
import { 
  ...
  MoreVertical, Trash2, Mail, Filter, Settings, X
} from 'lucide-react'
...
export default function TeamManagement({ organizationId }: TeamManagementProps) {
  ...
  // Mutations
  const updateMemberMutation = api.team.updateTeamMember.useMutation({
    onSuccess: () => {
    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="members" className="space-y-6">
        <TabsList className="bg-gray-900/50 border border-gray-800">
          <TabsTrigger value="members" className="data-[state=active]:bg-electric-purple data-[state=active]:text-white">
            Members ({teamData?.members.length || 0})
          </TabsTrigger>
          <TabsTrigger value="invitations" className="data-[state=active]:bg-electric-purple data-[state=active]:text-white">
            Invitations ({teamData?.invitations?.length || 0})
          </TabsTrigger>
          <TabsTrigger value="activity" className="data-[state=active]:bg-electric-purple data-[state=active]:text-white">
            Activity
          </TabsTrigger>
          <TabsTrigger value="roles" className="data-[state=active]:bg-electric-purple data-[state=active]:text-white">
            Roles & Permissions
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="roles" className="space-y-6">
          <Card className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 border-gray-800">
            <CardHeader>
              ...
              <CardDescription>Understanding team member permissions and access levels</CardDescription>
            </CardHeader>
            <CardContent>
