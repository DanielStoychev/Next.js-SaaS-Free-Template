...
export default function BillingDashboard() {
  ...
  const planInfo = subscription
    ...
    : PLAN_FEATURES.FREE
  const StatusIcon = subscription?.status
    ? STATUS_ICONS[subscription.status as keyof typeof STATUS_ICONS]
    : CheckCircle
              ...
              <div className='grid md:grid-cols-2 gap-6'>
                <div>
                  ...
                  <div className='flex items-center gap-3'>
                    <div
                      className={`p-2 rounded-full ${STATUS_COLORS[subscription.status as keyof typeof STATUS_COLORS] || 'bg-gray-500/20 text-gray-500'}`}
                    >
              ...
              {subscription?.plan !== 'FREE' ? (
                <>
                  <Button
                    ...
                    disabled={
                      isProcessing || createBillingPortalSession.isPending
                    }
