...
export default function TeamManagement({
  ...
  const [activeView, setActiveView] = useState<'members' | 'activity'>(
    'members'
  )

  // Get team data
  const { data: teamData, isLoading } = api.team.getTeamMembers.useQuery({
    organizationId,
    ...
    <div className='space-y-8'>
      ...
      <div className='flex space-x-4'>
        <Button
          ...
          className={
            activeView === 'members'
              ? 'bg-electric-purple hover:bg-electric-purple/80'
              : ''
          }
        >
          Members
